...
- [ ] Sinkronkan branch `main` ke repository GitHub yang menjadi sumber deployment Vercel
- [ ] Uji `/manage-listings` dan bypass `admin_key` pada domain Vercel setelah deployment selesai
- [ ] Verifikasi variabel environment admin dan storage pada project Vercel tanpa membocorkan nilai rahasia
