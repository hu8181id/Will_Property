...
export default function Listing() {
  ...
  const queryInput = useMemo(() => ({
    ...
    minPrice: toNumber(filters.priceMin),
    maxPrice: toNumber(filters.priceMax),
